...
const Layout = () => {
    ...
    return (
        <>
                        ...
                        <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                            ...
                            <div className="hidden sm:ml-6 sm:block">
                                <div className="flex space-x-4">
                                    ...
                                    {
                                        user && (
                                            <Link to="/user" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">User</Link>
                                        )
                                    }
                                    ...
                                    <Link to="/search" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Search</Link>
                                    {
                                        !user && (
                                    ...
                                    }
                                    {
                                        user && user.role === 'admin' && (
                                            <Link to="/admin" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Admin</Link>
                                        )
                                    }
                                </div>
                            </div>
            ...
            {/* Outlet: vi trí render nội dung của các Route con (Home, About, User) */}
            <main>
                <Outlet />
            </main>
        </>
